...
description: Internal Phase 2 of the GTM Brain interview — not a user entry point. Use only when the marker says phase: strategy-readout. Synthesizes the business layer into a plain-language Strategy Readout and runs the resonance check ("is this your business?") that gates all technical work. Hands off to build-spec only once the owner confirms.
---
...
Using the captured business layer and the lens, fill **Part 1 — Strategy Readout** of the template (`../../reference/output-template.md`). Business language throughout:
