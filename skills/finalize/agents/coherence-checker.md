...
- **working_doc**: the full spec content (or its path — read it if a path).

No web access needed; this is a review of the document against itself and the plugin's own contracts.
